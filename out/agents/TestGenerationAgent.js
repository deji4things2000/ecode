...
class TestGenerationAgent {
    ...
    // ── Generation passes ─────────────────────────
    generateUnitTests(code, language, history) {
...
Include descriptive test names and comments.`,
    ...
    generateIntegrationTests(code, language, history) {
        return this.provider.complete({
...
Use mocking/stubbing appropriately.`,
    ...
    generateEdgeCaseTests(code, language, history) {
        return this.provider.complete({
...
concurrent access, network failures, malformed data, and security edge cases.`,
    ...
    assembleSuite(unit, integration, edge, language) {
        return [
